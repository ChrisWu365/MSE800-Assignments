...
class RecruiterAdvisorBot:
    def __init__(self):
        # Initialize Together client - you need to set TOGETHER_API_KEY environment variable
        # or configure api_key directly: client = Together(api_key="your-api-key")
    ...
    def analyze_cv(self, cv_text):
        """Analyze CV text using Meta Llama API."""
        try:
            prompt = """
    ...
    def run_gui(self):
        ...
        # Footer
        footer = tk.Label(root, text="Powered by Meta Llama", 
